...
// Add Email provider if Resend is configured
// Note: EmailProvider requires nodemailer package which is not installed by default
// Uncomment and install nodemailer if you want to enable email authentication
